...
def main():
    ...
    construct_UP(c_df, FLAGS.output_size, save_with_indices=FLAGS.save_with_indices, np_save_file=FLAGS.np_save_file, P=FLAGS.P_value) # make sure to pass in save path
...
if __name__ == '__main__':
    ...
    # main()
    remix(cal_path=None, val_path='./val_P20_unint8_first')