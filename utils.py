...
def eval_metrics(predictions, label_hot, num_classes=2, plot_auc=False, plot_precision_recall=False, print_short_sum=True, print_synopsis=True, return_values=False, color='black', save_auc=False):
    fpr = {}
    tpr = {}
    precision = {}
    recall = {}
    ...
    if plot_auc:
        ...
        ax.legend(loc=4)
        if save_auc:
            f.savefig('./AUC_curve_v2', dpi=600, format='png')
        plt.show()
